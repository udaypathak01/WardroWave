    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-pink-600 py-8">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl font-bold text-white mb-2">Women's Fashion</h1>
          <p className="text-gray-100">Discover premium women's clothing at unbeatable rental prices</p>
        </div>
      </div>
